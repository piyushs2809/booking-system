...
@section('title', 'Edit Booking - Booking System')
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('booking.update', $booking) }}" id="bookingForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3" id="slotSelection" style="display: none;">
                        ...
                        <select class="form-select @error('booking_slot') is-invalid @enderror" 
                            ...
                            <option value="first_half" {{ old('booking_slot', $booking->booking_slot) === 'first_half' ? 'selected' : '' }}>First Half (9:00 AM - 1:00 PM)</option>
                            <option value="second_half" {{ old('booking_slot', $booking->booking_slot) === 'second_half' ? 'selected' : '' }}>Second Half (1:00 PM - 6:00 PM)</option>
                        </select>
                        @error('booking_slot')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="time" 
                                       ...
                                       value="{{ old('booking_from_time', $booking->booking_from_time ? $booking->booking_from_time->format('H:i') : '') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="time" 
                                       ...
                                       value="{{ old('booking_to_time', $booking->booking_to_time ? $booking->booking_to_time->format('H:i') : '') }}">
